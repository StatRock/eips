# Overview of Web Site Process & Generation

(File:  "ReadMe.md" 3/25/2018)
...
Now you are ready to install the program, boot.exe, that builds files in the 'public' directory.  Enter the following:
